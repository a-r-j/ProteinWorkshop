...
from src.features.edge_features import (compute_scalar_edge_features,
                                        compute_vector_edge_features)
from src.features.edges import compute_edges
from src.features.node_features import (compute_scalar_node_features,
                                        compute_vector_node_features)
from src.features.representation import transform_representation
from src.types import (ScalarEdgeFeature, ScalarNodeFeature, VectorEdgeFeature,
                       VectorNodeFeature)
