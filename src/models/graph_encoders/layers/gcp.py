...
from src.models.graph_encoders.components import radial
from src.models.graph_encoders.components.wrappers import ScalarVector
from src.models.utils import get_activations, is_identity, safe_norm
...
class GCPEmbedding(nn.Module):
    def __init__(
        ...
        self.radial_embedding = partial(radial.compute_rbf, max_distance=cfg.r_max, num_rbf=cfg.num_rbf)
